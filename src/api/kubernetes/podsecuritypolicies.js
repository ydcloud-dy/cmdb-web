...
const BaseUrl = (cluster_id) => {
  return `/kubernetes/proxy/${cluster_id}/apis/policy/v1beta1/podsecuritypolicies`
}
...
export const PodSecurityPoliciesGet = (cluster_id, namespace, name) => {
  return service({
...
export const PodSecurityPoliciesCreate = (cluster_id, namespace, data) => {
  return service({
...
export const PodSecurityPoliciesUpdate = (cluster_id, namespace, name,  data) => {
  return service({
    url: `${BaseNamespaceUrl(cluster_id, namespace)}/${name}`,
    method: 'put',
    data
...
export const PodSecurityPoliciesDelete = (cluster_id, namespace, name) => {
  return service({
    url: `${BaseNamespaceUrl(cluster_id, namespace)}/${name}`,
    method: 'delete',
  })

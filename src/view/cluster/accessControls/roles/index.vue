...
import {
  ...
  RolesDelete,
  RolesGet,
  RolesList, RolesUpdate,
} from '@/api/kubernetes/roles'
...
const openDialog = () => {
  ...
  form.value = getK8sObject('roles', searchInfo.value.namespace, '')
  dialogYamlVisible.value = true
}
